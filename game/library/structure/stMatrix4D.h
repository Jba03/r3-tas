...
MATRIX4 static inline tdstMatrix4D matrix4_host_byteorder(tdstMatrix4D m)
{
 ...
 */
MATRIX4 static inline tdstMatrix4D matrix4_new(const tdstVector4D row0, const tdstVector4D row1, const tdstVector4D row2, const tdstVector4D row3)
{
    tdstMatrix4D m;
    m.row0 = row0;
    m.row1 = row1;
 ...
 */
MATRIX4 static inline tdstMatrix4D matrix4_mul(const tdstMatrix4D a, const tdstMatrix4D b)
{
    tdstMatrix4D m;
 ...
 */
MATRIX4 static inline tdstMatrix4D matrix4_inverse(const tdstMatrix4D m)
{
    tdstMatrix4D result;
 ...
 * '————————————————————'     '————————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_transpose(const tdstMatrix4D m)
{
    tdstMatrix4D result;
 ...
 * '—————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_make_translation(const float x, const float y, const float z)
{
    tdstMatrix4D result = matrix4_identity;
    result.m03 = x;
    result.m13 = y;
 ...
 * '———————————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_make_rotation_x(const float radians)
{
 ...
 * '———————————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_make_rotation_y(const float radians)
{
 ...
 * '——————————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_make_rotation_z(const float radians)
{
    const float sine = sin(radians);
    const float cosine = cos(radians);
 ...
 * '—————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_make_scale(const float x, const float y, const float z)
{
    tdstMatrix4D result = matrix4_identity;
    result.m00 = x;
    result.m11 = y;
 ...
 * '————————————————————'
 */
MATRIX4 static inline tdstMatrix4D matrix4_make_scale_vector3(const tdstVector3D v)
{
    tdstMatrix4D result = matrix4_identity;
    result.m00 = v.x;
    result.m11 = v.y;
 ...
 */
MATRIX4 static inline tdstMatrix4D matrix4_perspective(const float fov_y, const float aspect, const float near_z, const float far_z)
{
    tdstMatrix4D result = matrix4_identity;
 ...
 */
MATRIX4 static inline tdstMatrix4D matrix4_ortho(const float left, const float right, const float bottom, const float top, const float near, const float far)
{
 ...
 */
MATRIX4 static inline tdstMatrix4D matrix4_lookat(const tdstVector3D eye, const tdstVector3D center, const tdstVector3D up)
{
...
VECTOR4 static inline tdstVector4D vector4_mul_matrix4(const tdstVector4D v, const tdstMatrix4D m)
{
    tdstVector4D result;
