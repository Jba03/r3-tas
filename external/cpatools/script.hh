...
struct TranslationEngine {
  ...
  TranslationResult *translate(pointer<structure::stSuperObject> actor, pointer<Node> tree) {
    initialNode = tree;
...
static std::map<Lexer::Token::Type, std::string> TokenNames {
...
inline void testLexer(std::string source) {
